...
data class ViewClassworkUiState(
    ...
    val studentSubmissionLate: Boolean = false,
    val studentSubmissionPoint: Int? = null,
    val studentSubmissionState: SubmissionState = SubmissionState.SUBMISSION_STATE_UNSPECIFIED,
